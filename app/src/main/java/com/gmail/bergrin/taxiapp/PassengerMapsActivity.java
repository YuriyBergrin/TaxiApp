package com.gmail.bergrin.taxiapp;
...
public class PassengerMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void gettingNearestTaxi() {
        ...
        geoQuery.removeAllListeners();//т.к. у нас там рекурсивная функция ниже и будет создаваться кучи listeners
    ...
    @SuppressLint("MissingSuperCall")//todo SHO DELAT`
    @Override
